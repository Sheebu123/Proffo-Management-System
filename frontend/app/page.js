  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-5xl flex-col justify-center px-4 py-12">
      <section className="rounded-2xl border border-amber-100 bg-white p-8 shadow-sm">
        <p className="text-sm font-medium uppercase tracking-wider text-emerald-700">Resume Project</p>
        <h1 className="mt-2 text-4xl font-bold text-stone-900">SmartSalon with Next.js + Django API</h1>
        <p className="mt-4 max-w-2xl text-stone-600">
          This frontend uses Next.js and Tailwind. Data and business logic come from the Django backend API.
        </p>
